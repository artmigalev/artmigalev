...
### ✨ Christmas-Shop
🔗 https://github.com/artmigalev/christmas-shop
Веб-сайт, состоящий из двух страниц, сделан  адаптивным и добавлена интерактивность. Пришло время создать уютное место для покупки интересных подарков! Cемантический адаптивный веб-дизайн, легко поддерживаемый читаемый код,экспорт стилей и графики из Figma;
